...
class reser {
    ...
    amt = sno+ 300;
    System.out.println("\n\n"+" ======You should pay: "+ amt + "TAKA=======");
    paymentmethod p = new card();
    paymentmethod p1 = new mobile();
    Scanner sc = new Scanner(System.in);
    int ch;
    do {
        System.out.println("1) Pay through card\n2) Pay through mobile banking\n3) Main menu");
...
abstract class paymentmethod{
    ...
    private int pin;
    reser r = new reser();
    private int amount=r.amt;
    private int sno=r.sno;
    void makepayment(){
        ...
        pin=input.nextInt();
        System.out.println("===========Taka has been debited from you account===========\n===========Ticket confirmed==========");
    ...
    void makepayment(){
        ...
        Scanner input = new Scanner(System.in);
        mobile_num= input.nextInt();
        System.out.println("Enter mobile card pin: ");
        pin=input.nextInt();
        System.out.println("==========="+ r.amt+ "Taka has been debited from you account===========\n===========Ticket confirmed==========");
	...
	// <-- Method for handling admin operations after login menu -->
		...
		public void passengerDisplay() throws IOException {
			...
			DataInputStream dis1 = new DataInputStream(new FileInputStream("UserData.txt"));
